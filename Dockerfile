...
RUN apt-get update && apt-get install -y libcurl4=7.64.0-4+deb10u1 libpython3.7-minimal=3.7.3-2+deb10u1 \
 ...
 libmagic1=1:5.35-4+deb10u1 file=1:5.35-4+deb10u1 krb5-locales=1.17-3 manpages=4.16-2 netcat-traditional=1.10-41.1 \
 ucf=3.0038+nmu1 xz-utils=5.2.4-1 libapr1=1.6.5-1+b1 libaprutil1=1.6.1-4 apache2-utils=2.4.38-3+deb10u3 \
 binutils-common=2.31.1-16 libbinutils=2.31.1-16 binutils-x86-64-linux-gnu=2.31.1-16 binutils=2.31.1-16 \
 libisl19=0.20-2 libmpfr6=4.0.2-1 libmpc3=1.1.0-1 cpp-8=8.3.0-6 cpp=4:8.3.0-1 python3-lib2to3=3.7.3-1 \
 python3-distutils=3.7.3-1 dh-python=3.20190308 fonts-dejavu-core=2.37-1 fontconfig-config=2.13.1-2 libcc1-0=8.3.0-6 \
 libgomp1=8.3.0-6 libitm1=8.3.0-6 libatomic1=8.3.0-6 libasan5=8.3.0-6 liblsan0=8.3.0-6 libtsan0=8.3.0-6 \
 libubsan1=8.3.0-6 libmpx2=8.3.0-6 libquadmath0=8.3.0-6 libgcc-8-dev=8.3.0-6 gcc-8=8.3.0-6 gcc=4:8.3.0-1 \
 geoip-database=20181108-1 libbsd0=0.9.1-2 libc-dev-bin=2.28-10 linux-libc-dev=4.19.98-1 libc6-dev=2.28-10 \
 libkeyutils1=1.6-6 libkrb5support0=1.17-3 libk5crypto3=1.17-3 libkrb5-3=1.17-3 libgssapi-krb5-2=1.17-3 \
 libsasl2-modules-db=2.1.27+dfsg-1+deb10u1 libsasl2-2=2.1.27+dfsg-1+deb10u1 libldap-common=2.4.47+dfsg-3+deb10u1 \
 libldap-2.4-2=2.4.47+dfsg-3+deb10u1 libnghttp2-14=1.36.0-2+deb10u1 libpsl5=0.20.2-2 \
 librtmp1=2.4+20151223.gitfa8646d.1-2 libssh2-1=1.8.0-2.1 libevent-2.1-6=2.1.8-stable-4 libexpat1-dev=2.2.6-2+deb10u1 \
 ...
 libnginx-mod-http-dav-ext=1.14.2-2+deb10u1 libnginx-mod-http-echo=1.14.2-2+deb10u1 \
 libnginx-mod-http-geoip=1.14.2-2+deb10u1 libnginx-mod-http-image-filter=1.14.2-2+deb10u1 \
